	...
	<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>用 户 详 情 信 息 添 加</h2>
						
					</div>
					<div class="box-content">
						<form class="form-horizontal" action="/admin/userinfos/store/{{ $users->id }}" method="post" enctype="multipart/form-data">
							...
							<fieldset>
							  <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" disabled name="uname" value="{{ $users->uname}}">
							   ...
							   <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="age" value="{{ old('age') }}">
							   ...
							   <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="addr" >
